...
export const LOGIN_SCREEN = 'sub.LoginScreen';
export const SIGN_UP_SCREEN = 'sub.SignUpScreen';
export const FORGOT_PASSWORD_SCREEN = 'sub.ForgotPasswordScreen';
// tabs
export const HOME_SCREEN = 'sub.HomeScreen';
